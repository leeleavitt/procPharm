#The image import has the wrong names, tritc is actually cy5
...
img5.1<-"gfp.start.ci.ltl.rs.png"
img6.1<-"gfp.dapi.end.ci.ltl.rs.png"
...
##Mean Trace
t.340<-xtabs(Intensity_MeanIntensity_f2_380~ImageNumber+ObjectNumber, f2.img)
t.380<-xtabs(Intensity_MeanIntensity_f2_340~ImageNumber+ObjectNumber, f2.img)
t.dat<-t.340/t.380
