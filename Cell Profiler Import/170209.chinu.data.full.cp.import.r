...
main.dir<-"E:/Data/Mario/"
exp.dir<-select.list(list.dirs(), multiple=T)

#name the experiments you will assess today.
rd.names<-c(
"RD.170125.w1.l4.ipsi.sham",
"RD.170125.w2.l4.contra.sham",
"RD.170125.w3.l5l6.ipsi.sham",
"RD.170125.w4.l5l6.contra.sham",
"RD.170127.w1.snl.ipsi.l4",
"RD.170127.w2.snl.ipsi.l5l6",
"RD.170127.w3.snl.contra.l5l6",
"RD.170127.w4.snl.contra.l4")
...
if(length(green)>1){
	...
	"Intensity_MeanIntensity_DNA_ci",
	"Location_Center_X",
	"Location_Center_Y")
...
img6<-readPNG("fura2.png")
img7<-readPNG("gfp.tritc.dapi.png")
img8<-readPNG("bf.gfp.tritc.dapi.png")
