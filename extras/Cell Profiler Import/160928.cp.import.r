# Do this for multiple folders.  So i am going to select.list ll the folders#in my current directory that hass all my experiments listed.
exp.dir<-select.list(list.dirs(), multiple=T)
main.dir<-"D:/DRG Profiling/Short Protocols"
setwd(main.dir)
rd.names<-c(
"RD.160915.55.f.p1",
"RD.160915.55.f.p2")
...
setwd(main.dir)
rm(f2.img)
source("C:\\Users\\Lee Leavitt\\Desktop\\Box Sync\\procpharm\\procPharm.160929.r")
}
