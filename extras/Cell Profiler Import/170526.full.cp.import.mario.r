...
img1.1<-"bf.gfp.tritc.dapi.start.png"
img2.1<-"gfp.tritc.dapi.start.ci.ltl.rs.png"
img3.1<-"gfp.start.ci.ltl.rs.png"
img4.1<-"tritc.start.ci.ltl.rs.png"
img5.1<-"bf.start.lab.png"
img6.1<-"dapi.end.lab.png"
img7.1<-"fura2.png"
img8.1<-NULL
