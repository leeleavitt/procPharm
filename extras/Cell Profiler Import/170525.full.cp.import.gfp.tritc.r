...
rd.names<-c(
"RD.170607.53.f.cd1.p1",
"RD.170607.53.f.cd1.p2"
)
...
img2.1<-"gfp.tritc.start.ci.ltl.rs.png"
img3.1<-"tritc.start.ci.ltl.rs.png"
img4.1<-"tritc.end.ci.ltl.rs.png"
img5.1<-"gfp.start.ci.ltl.rs.png"
img6.1<-"gfp.end.ci.ltl.rs.png"
img7.1<-"bf.start.lab.png"
img8.1<-"bf.end.lab.png"
...
c.dat.names<-c(
	...
	"AreaShape_Perimeter",
	"Intensity_MeanIntensity_prop_start_ci",
	"Intensity_MeanIntensity_prop_end_ci",
