...
#}else{img.g<-NULL}
img2<-png::readPNG("bf.f2.png")
img3<-png::readPNG("tritc.dapi.png")
img4<-png::readPNG("bf.lab.png")
img5<-png::readPNG("gfp.png")
img6<-png::readPNG("tritc.png")
...
tmp.rd <- list(t.dat=t.dat,t.340=t.340,t.380=t.380,te.340=t.e.340,te.380=t.e.380, 
